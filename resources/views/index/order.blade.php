    ...
    <div class="maincont">
     ...
     @foreach($data as $key=>$val)
      <table>
       ...
       <img src="http://test.com/{{$val->g_img}}"  width="150px" />
        </td>
        <td width="50%">
         <h3>{{$val->g_name}}</h3>
         <input type="hidden" name="g_id" id="g_id" p_id="{{$val->g_id}}">
         <time>下单时间：2015-08-11  13:51</time>
        </td>
        <td align="right"><input type="text" class="spinnerExample" /></td>
       </tr>
       <tr>
        <th colspan="4"><strong class="orange">¥{{$val->g_pirce}}</strong></th>
       </tr>
       <tr>
        <td width="100%" colspan="4">
        <a href="delcart{{$val->c_id}}">
        <input type="checkbox"  name="1" /> 删除
        </a>
        </td>
       </tr>
      </table>
     ...
     <table>
      <tr>
       ...
       <td width="40%"><a href="successdo{{$val->g_id}}" class="jiesuan">去结算</a></td>
      </tr>
     </table>
    </div><!--gwcpiao/-->
    </div><!--maincont-->
