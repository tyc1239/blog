    ...
    <div class="maincont">
     ...
     <div class="dingdanlist" onClick="window.location.href='address.html'">
      <table>
       ...
       <tr>
        <th colspan="3"><strong class="orange">¥{{$val->g_pirce}}</strong></th>
       </tr>
       
       
       <tr>
        <td class="dingimg" width="75%" colspan="2">商品金额</td>
        <td align="right"><strong class="orange">¥{{$val->pirce}}</strong></td>
       </tr>
       <tr>
    ...
    <div class="gwcpiao">
     <table>
      <tr>
       ...
       <td width="50%">总计：<strong class="orange">¥{{$val->g_pirce}}</strong></td>
       <td width="40%"><a href="addsuccess{{$val->g_id}}" class="jiesuan">提交订单</a></td>
      </tr>
       @endforeach
     </table>
    </div><!--gwcpiao/-->
