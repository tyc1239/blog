            ...
            <div id="side-nav">
                <ul id="nav">
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('消息群发','/admin/group/index')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>消息群发</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('标签名添加','/admin/group/taghtml')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>标签名添加</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('用户添加标签','/admin/group/addopenid')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>用户添加标签</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('根据标签群发','/admin/group/setopenid')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>标签群发</cite></a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('菜单管理','/admin/menu/index')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>菜单列表</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('标签添加','/admin/menu/add')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>菜单添加</cite></a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('首次关注回复设置','/admin/subscribe')">
                                <a href="/admin/subscribe" target="_blank">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>首次关注回复设置</cite></a>
                            </li>

                            <li>
                                <a onclick="xadmin.add_tab('素材管理页面','/admin/subscribelist')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>素材上传内容</cite></a>
                            </li>

                            <li>
                                <a onclick="xadmin.add_tab('素材管理页面','/admin/materiallist')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>素材管理</cite></a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('自定义关键字回复','/admin/subscribe')">
                                    {{--<a href="/admin/subscribe" target="_blank">--}}
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>自定义关键字回复</cite></a>
                            </li>

                            <li>
                                <a onclick="xadmin.add_tab('优惠券添加','/wechat/index')">
                                    {{--<a href="/admin/subscribe" target="_blank">--}}
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>优惠券添加</cite></a>
                            </li>
