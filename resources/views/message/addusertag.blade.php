...
<div class="x-body">
    ...
    <form class="layui-form layui-col-space5" action="/material/addusertagdo" method="post">
        @csrf
        ...
        <button class="layui-btn layui-btn-normal sendAll" type="submit">添加标签</button>
    </form>
</div>
</body>
</html>
