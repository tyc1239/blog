		...
		@if ($errors->any())
			...
			<form action="adddo" method="post" enctype="multipart/form-data">
				...
				@csrf
			 		...
			 		<p>网站网址：<input type="text" name="web"></p>
			 		<p>链接类型：<input type="radio" name="line" value="1">LOGO链接
								 <input type="radio" name="line" value="0">文字链接
					</p>
			 		<p>图片LOGO:   <input type="file" name="logo"></p>
			 		<p>网站联系人： <input type="text" name="ptc"></p>
			 		<p>网站介绍：<textarea name="desc" id="" cols="30" rows="10"></textarea></p>
			 		<p>是否显示：<input type="radio" name="show" value="1">是
