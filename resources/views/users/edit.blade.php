<html>
		...
		<body>
			...
			@endif
			 ...
			 <form action="{{url('user/update/'.$data->uid)}}" method="post" enctype="multipart/form-data">
			 		@csrf
			 		用户名：<input type="text" name="username" value="{{$data->username}}" placeholder="用户名"><br><br>
			 		年龄：<input type="number" name="age" value="{{$data->age}}" placeholder="年龄"><br><br>
			 		班级：<input type="number" name="class" value="{{$data->class}}" placeholder="班级"><br><br>
			 		头像：<img src="http://upload.com/{{$data->head}}"  width="100px"><input type="file" name="edit_head"><br><br>
					<!-- <button>提交</button><br> -->
